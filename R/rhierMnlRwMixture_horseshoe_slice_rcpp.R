rhierMnlRwMixture_horseshoe_slice=function(Data,Prior,Mcmc, MH_burnin, fix_p_burnin, p_MH = 0){
#
# revision history:
...
# 09/22/2014
###################################################################
draws =  rhierMnlRwMixture_horseshoe_slice_rcpp_loop(lgtdata, Z,
                                     deltabar, Ad, mubar, Amu,
                                     nu, V, s,
                                     R, keep, nprint, drawdelta,
                                     as.matrix(olddelta), a, oldprob, oldbetas, ind, SignRes, p_MH, MH_burnin, fix_p_burnin)
####################################################################
